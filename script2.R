...
input_string_left_static <- "Turkey_Epipaleolithic,Israel_Natufian,,Russia_LakeBaikal_N.SG,Morocco_EN.SG,Dinka.DG"
input_string_left_dynamic <- ""
input_string_right_static <- "Ethiopia_4500BP, Russia_MAI_HG.SG, Morocco_Iberomaurusian, Turkey_Boncuklu_N, Iran_Wezmeh_N.SG, Sidelkino_Noudo_EHG, Bichon_WHG, China_AmurRiver_Mesolithic, Georgia_Satsurblia, Iran_GanjDareh_N_195"
